    ...
    <div className='py-20 bg-gray-200 text-black'>
      <footer className='max-w-7xl mx-auto flex flex-col p-5 sm:flex-row gap-10'>
        <div className='space-y-5 flex-1'>
            ...
            <p className='text-xs w-full sm:max-w-[30vw]'>We offers a comprehensive suite of digital marketing services that cover all aspectsof our online presence. From SEO and social media marketing to content creation and PPC advertising, they have the expertise and resources to handle our diversemarketing needs.</p>
